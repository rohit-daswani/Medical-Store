...
function SidebarContent() {
  ...
  return (
    <div className="flex h-full flex-col bg-[var(--sidebar)] border-r border-[var(--sidebar-border)]">
      {/* Logo */}
      <div className="flex h-16 items-center px-6 border-b border-[var(--sidebar-border)]">
        <div className="flex items-center space-x-2">
          ...
          <span className="text-xl font-bold text-white">MediStore Pro</span>
        </div>
      </div>
          ...
          return (
            <Link
              ...
              className={cn(
                ...
                isActive
                  ? 'bg-[var(--brand-card-blue)] text-[var(--brand-deep-blue)] border border-[var(--brand-light)]'
                  : 'text-white hover:bg-[var(--sidebar-accent)] hover:text-white'
              )}
            >
